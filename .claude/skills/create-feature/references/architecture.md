...
| Components/widgets | `src/components/...` | Presentational + interactive UI; generic widgets in `src/components/widgets/` | `src/components/widgets/index.tsx`, `src/components/templates/TemplateRenderer.tsx` |
...
7. **Verify** — run `scripts/verify.mjs`.
